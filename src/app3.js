...
export default function app3() {
  return (
    ...
    <div className='container'>
        ...
        <div className='tai'>
            <img src="https://th.bing.com/th/id/OIP.-4RJk-TNzc0Ulbu6-Ogx_AHaFR?rs=1&pid=ImgDetMain"></img>
            <br></br>
            <h3>Apple</h3>
            <h3>price : 300</h3>
            <button>Add</button>
    ...
    <div className='container'>
        <div className='con'>
            <img src="https://th.bing.com/th/id/OIP.gHHwNXzq_P6NpIo06jjaGAHaE8?w=278&h=186&c=7&r=0&o=5&dpr=1.3&pid=1.7"></img>
            <br></br>
            <h3>Guava</h3>
            <h3>price : 300</h3>
            <button>Add</button>
        ...
        <div className='ner'>
            <img src="https://loe.org/content/2014-04-18/10-bananabunch.gif"></img>
            <br></br>
            <h3>Mango</h3>
            <h3>price : 300</h3>
            <button>Add</button>
